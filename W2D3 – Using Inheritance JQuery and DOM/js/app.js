...
const printPersonalDetails = function () {
    ...
    console.log(`${this.getName()} was born on ${this.dateOfBirth}`);
}
const john = Object.create(person);
john.setName("John");
john.dateOfBirth = new Intl.DateTimeFormat('en-US').format(new Date(Date.UTC(1998, 11, 10,0,0)));
...
class Employee2 extends Person2 {
    constructor(jobTitle) {
        ...
        this.salary = "0";
        this.hireDate = new Intl.DateTimeFormat('en-US').format(new Date());
    }
    doJob () {
...
// const employee = {
//     salary: "0",
//     hireDate: new Intl.DateTimeFormat('en-US').format(new Date()),
//     doJob: function (jobTitle) {
//         return `${jobTitle}`;
//     }
// };
const printEmployeeDetails = function () {
    console.log(`${this.getName()} is a ${this.doJob()} who earns \$${this.salary}`);
}
let Anna =  new Employee2("Programmer");
Anna.salary = "249.995.50";
Anna.setName("Anna");


const printAnnasSalary = printEmployeeDetails.bind(Anna, "Programmer");
printAnnasSalary();
...
let john1 = new Person3("John", 1998,12,10);
console.log(john1.toString());
